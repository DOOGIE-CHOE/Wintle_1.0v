...
<header style="z-index:100;">
    ...
    <div id="header-gnb">
        <div class="HeaderImg1">  <!-- HeaderImg[i] {0 : 홈 버튼, 1 : 로고, 2 : 메뉴 버튼} -->
            <img src="<?php echo URL?>img/pavicon/logo_white_wintle_new1.png" style="position:relative; height:28px; top:13px;"  onclick="$.pagehandler.loadContent('<?php echo URL?>index','all');">
        </div>
